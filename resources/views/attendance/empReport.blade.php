                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 d-flex gap-2 align-items-end">
                                                <button type="submit" class="myBtn myBtnPrimary"
                                                    style="height: fit-content;">Search</button>
                                                <a href="{{ route('empreport') }}" class="myBtn btn-secondary"
                                                    style="height: fit-content;">Reset</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="whiteBigCard">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-3 tableFlex">
                                        <h4 class="mb-0">
                                            <ion-icon name="list-outline"></ion-icon> Attendance Records
                                        </h4>


                                        <button class="myBtn myBtnPrimary excelBtn">
                                    ...
                                    <div class="mytableCon">
                                        <table class="table table-bordered excelTable paginationTable">
                                            <thead>
                                                <tr>
                                                    <th>Date</th>
                                                    <th>Clock In</th>
