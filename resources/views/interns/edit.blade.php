        ...
        <div class="content">
            <div class="form-card">
                ...
                <form method="POST" action="{{ route('interns.update', $intern) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Contact</label>
                        <input type="text" name="contact" value="{{ old('contact', $intern->contact) }}" maxlength="10"
                            pattern="[0-9]{1,13}" inputmode="numeric"
                    ...
                    <div class="form-group">
                        ...
                        <select name="marital_status">
                            ...
                            <option value="married" {{ $intern->marital_status === 'married' ? 'selected' : '' }}>Married
                            </option>
                            <option value="divorced" {{ $intern->marital_status === 'divorced' ? 'selected' : '' }}>
                                Divorced</option>
                            <option value="widowed" {{ $intern->marital_status === 'widowed' ? 'selected' : '' }}>Widowed
                            </option>
                        </select>
                    </div>
